	...
	tests := []struct {
	...
	}{
		{
			...
			db: Database{
				Name:      "my_sqlite_db",
				Charset:   "UTF8",
				Collation: "", // Collation can be empty for SQLite
				Tables: []Table{
					{
						Name: "customers",
						Columns: []Column{
							{Name: "customer_id", Type: "INTEGER", PrimaryKey: true}, // Set PrimaryKey to true
						},
					},
				},
			},
...
func TestValidateTable(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "valid table",
			table:    Table{Name: "customers", Columns: []Column{{Name: "customer_id", Type: "INTEGER", PrimaryKey: true}}}, // Set PrimaryKey to true
			expected: "",
		},
		{
			name:     "missing table name",
			table:    Table{Columns: []Column{{Name: "customer_id", Type: "INTEGER", PrimaryKey: true}}},
		...
		{
			name:     "no primary key",
			table:    Table{Name: "customers", Columns: []Column{{Name: "customer_id", Type: "INTEGER"}}},
